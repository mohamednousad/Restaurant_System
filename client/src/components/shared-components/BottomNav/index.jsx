...
const BottomNav = () => {
  ...
  return (
    <>
      <div
        className={`fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-2 h-16 flex justify-around items-center transition-transform duration-300 ${
      ...
      >
        ...
        {visible && (
          <button
            ...
            className="absolute bottom-8 bg-yellow-500 text-white rounded-full p-3 shadow-lg disabled:opacity-0"
          >
            <BiSolidDish size={24} />
          </button>
        )}
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-yellow-500"
            />
          </div>
          <div>
            <label className="block text-gray-700 mb-1 text-sm">
          ...
          <div>
            ...
            <div className="flex items-center justify-between bg-gray-100 p-2 rounded">
              <button
                onClick={decrement}
                className="text-gray-700 text-xl px-3"
              >
                -
              </button>
