...
import Register from "../../components/app-components/auth/register";
import Login from "../../components/app-components/auth/login";
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <img
         ...
         />   <h1 className="text-lg font-semibold text-[#1a1a1a] tracking-wide">NAGER</h1>
        </div>
